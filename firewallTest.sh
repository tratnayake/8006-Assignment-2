...
function testSynFin {
	...
	startTestPrompt "$1" ": SYN FIN attack" 

	hping3 $remoteIP -S -F -p 80 -c 10

	endTestPrompt "$1" ": SYN FIN attack" 
...
echo "What is the IP of the FIREWALL machine you will be using to SSH into?"
...
echo "The remote Firewall IP to connect to is $firewallIP"
